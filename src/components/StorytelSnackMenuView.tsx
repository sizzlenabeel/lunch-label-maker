...
import { StorytelSnackMenuPDF } from './StorytelSnackMenuPDF';

export function StorytelSnackMenuView() {
    ...
    <div className="bg-white shadow rounded-lg p-6">
      ...
      <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 mb-6">
        <p className="text-sm text-purple-800">
          This menu shows snack products for Storytel for week {selectedWeek} with prices.
          Both original and English translations are displayed side by side.
        </p>
      </div>

      <StorytelSnackMenuPDF 
